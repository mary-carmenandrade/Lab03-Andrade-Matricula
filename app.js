...
app.post('/confirmacion', (req, res) => {
    ...
    const costoModulo = precios[curso][modulo];
    const descuento = medioPago === 'Pago en efectivo' ? costoModulo * 0.1 : 0;
    const totalAPagar = costoModulo - descuento;

    res.render('confirmacion', { curso, medioPago, modulo, totalAPagar, costoModulo});
});
